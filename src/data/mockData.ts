...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    categoryName: 'Món Chính Luxury',
    images: [
      'https://images.unsplash.com/photo-1625938146369-ad8024139380?auto=format&fit=crop&q=80&w=800',
      'https://images.unsplash.com/photo-1553240799-36bbf332a5c3?auto=format&fit=crop&q=80&w=800'
    ],
    rating: 4.8,
    reviewCount: 94,
    isFeatured: true,
